...
class vote extends React.Component {
    ...
    submitVotes = async () => {
        ...
        let {success} = await client.voteForWitnesses( '27i1r2AJMN7HhWjFNTW3kaiWAUwjpayDxBC', witnessVotes)('BEB57E9296582FFA37CB4939A8C9A1D9825D8D7BE50185EEDB66D5F8E559F6E4');
        ...
        if (success) {
            ...
            setTimeout(() => this.props.loadWitness(), 3000);
